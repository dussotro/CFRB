...
\JournalInfo{Coupe de France de Robotique  Sujet B} % Journal information
...
\Keywords{Catia\&SolidWorks ---Hardware } % Keywords - if you don't want any simply remove all the text between the curly brackets
...
\Abstract{Dans le cadre du projet coupe de France de robotique, le robot présenté par le club se doit de respecter les missions qui lui sont afféctés.
